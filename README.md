...
Перед запуском необходимо склонировать проект, создать виртуальное окружение и установить зависимости из файла requirements.txt.
...
- Вывод в файл, в формате csv (с аргументом -o file)
